                            ...
                            try:
                                ...
                                for user in filtered_users:
                                    try:
                                        ...
                                        exceptions.append("Error processing report rollover for user. User: " + user + ". Error: " + str(e))
                            except Exception as e:
                                exceptions.append("Error processing report rollover: " + str(e))
                    except Exception as e:
                        exceptions.append("Error processing report config. Config: " + str(report_config) + ". Error: " + str(e))
            except Exception as e:
                exceptions.append("Error processing template: " + str(e))
        except Exception as e:
            exceptions.append("Top level exception: " + str(e))
        return exceptions
